...
public class SearchActBindingImpl extends SearchActBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(1, 
            new String[] {"search_results_empty_view", "loading_view"},
            new int[] {2, 3},
            new int[] {com.zopnote.android.merchant.R.layout.search_results_empty_view,
    ...
    public SearchActBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private SearchActBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (android.widget.LinearLayout) bindings[6]
            , (android.support.design.widget.CoordinatorLayout) bindings[5]
            , (com.zopnote.android.merchant.databinding.SearchResultsEmptyViewBinding) bindings[2]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeEmptyView((com.zopnote.android.merchant.databinding.SearchResultsEmptyViewBinding) object, fieldId);
            case 1 :
                return onChangeLoadingView((com.zopnote.android.merchant.databinding.LoadingViewBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeEmptyView(com.zopnote.android.merchant.databinding.SearchResultsEmptyViewBinding EmptyView, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
