...
public class MoveCustomerFragBindingImpl extends MoveCustomerFragBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            new String[] {"customers_empty_view", "loading_view"},
            new int[] {1, 2},
            new int[] {com.zopnote.android.merchant.R.layout.customers_empty_view,
                com.zopnote.android.merchant.R.layout.loading_view});
        sViewsWithIds = new android.util.SparseIntArray();
        sViewsWithIds.put(R.id.contentView, 3);
        sViewsWithIds.put(R.id.moveCustomerHintTitle, 4);
        sViewsWithIds.put(R.id.moveCustomerHintText, 5);
    ...
    public MoveCustomerFragBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private MoveCustomerFragBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (android.widget.LinearLayout) bindings[3]
            , (com.zopnote.android.merchant.databinding.CustomersEmptyViewBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeEmptyView((com.zopnote.android.merchant.databinding.CustomersEmptyViewBinding) object, fieldId);
            case 1 :
                return onChangeLoadingView((com.zopnote.android.merchant.databinding.LoadingViewBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeEmptyView(com.zopnote.android.merchant.databinding.CustomersEmptyViewBinding EmptyView, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
