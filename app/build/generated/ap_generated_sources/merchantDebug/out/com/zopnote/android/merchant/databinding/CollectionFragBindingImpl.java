...
public class CollectionFragBindingImpl extends CollectionFragBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            new String[] {"payments_empty_view", "network_error", "loading_view"},
            new int[] {1, 2, 3},
    ...
    public CollectionFragBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private CollectionFragBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
