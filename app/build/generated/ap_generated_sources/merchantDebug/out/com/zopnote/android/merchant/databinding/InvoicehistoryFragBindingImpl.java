...
public class InvoicehistoryFragBindingImpl extends InvoicehistoryFragBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            new String[] {"payments_empty_view", "loading_view"},
            new int[] {1, 2},
            new int[] {com.zopnote.android.merchant.R.layout.payments_empty_view,
    ...
    public InvoicehistoryFragBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private InvoicehistoryFragBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (android.widget.LinearLayout) bindings[3]
            , (com.zopnote.android.merchant.databinding.PaymentsEmptyViewBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeEmptyView((com.zopnote.android.merchant.databinding.PaymentsEmptyViewBinding) object, fieldId);
            case 1 :
                return onChangeLoadingView((com.zopnote.android.merchant.databinding.LoadingViewBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeEmptyView(com.zopnote.android.merchant.databinding.PaymentsEmptyViewBinding EmptyView, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
