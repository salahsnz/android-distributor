...
public class IndentFragBindingImpl extends IndentFragBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            new String[] {"indent_empty_view", "network_error", "loading_view"},
            new int[] {1, 2, 3},
            new int[] {com.zopnote.android.merchant.R.layout.indent_empty_view,
    ...
    public IndentFragBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private IndentFragBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            , (android.widget.LinearLayout) bindings[4]
            , (com.zopnote.android.merchant.databinding.IndentEmptyViewBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeEmptyView((com.zopnote.android.merchant.databinding.IndentEmptyViewBinding) object, fieldId);
            case 1 :
    ...
    private boolean onChangeEmptyView(com.zopnote.android.merchant.databinding.IndentEmptyViewBinding EmptyView, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
