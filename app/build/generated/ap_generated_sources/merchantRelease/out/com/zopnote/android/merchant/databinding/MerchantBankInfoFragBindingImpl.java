...
public class MerchantBankInfoFragBindingImpl extends MerchantBankInfoFragBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.stepTitle, 3);
        sViewsWithIds.put(R.id.accountName, 4);
        sViewsWithIds.put(R.id.accountNo, 5);
        sViewsWithIds.put(R.id.ifscCode, 6);
        sViewsWithIds.put(R.id.bankName, 7);
        sViewsWithIds.put(R.id.submitBankInfo, 8);
        sViewsWithIds.put(R.id.closeBankInfo, 9);
    }
    // views
    @NonNull
    ...
    public MerchantBankInfoFragBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private MerchantBankInfoFragBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
