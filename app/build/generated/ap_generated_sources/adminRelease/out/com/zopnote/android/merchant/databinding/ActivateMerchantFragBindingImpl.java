...
public class ActivateMerchantFragBindingImpl extends ActivateMerchantFragBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_register_fields, 5);
        sViewsWithIds.put(R.id.merchantName, 6);
        sViewsWithIds.put(R.id.merchantBusinessName, 7);
        sViewsWithIds.put(R.id.editTXTmerchantMobile, 8);
        sViewsWithIds.put(R.id.submitActivateMerchant, 9);
    }
    // views
    @NonNull
    ...
    public ActivateMerchantFragBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private ActivateMerchantFragBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
