...
public class ProfileFragBindingImpl extends ProfileFragBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.addressLine1SpinnerContainer, 5);
        sViewsWithIds.put(R.id.addressLine2, 6);
        sViewsWithIds.put(R.id.route, 7);
    }
    // views
    @NonNull
    ...
    public ProfileFragBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ProfileFragBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
