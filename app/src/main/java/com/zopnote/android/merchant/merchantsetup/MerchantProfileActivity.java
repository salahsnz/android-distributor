...
public class MerchantProfileActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.merchant_profile_act);
       ...
       /*  viewmodel.apiCallRunning.observe(this, new Observer<Boolean>() {
            ...
            public void onChanged(@Nullable Boolean running) {
                if (running) {
                    progressDialog = new ProgressDialog(MerchantProfileActivity.this);
                    progressDialog.setMessage(MerchantProfileActivity.this.getResources().getString(R.string.adding_route_running_message));
       ...
       viewmodel.apiCallError.observe(this, new Observer<Boolean>() {
            ...
            public void onChanged(@Nullable Boolean error) {
                if (error) {
                    Utils.showFailureToast(MerchantProfileActivity.this,
        ...
        viewmodel.apiCallSuccess.observe(this, new Observer<Boolean>() {
            ...
            public void onChanged(@Nullable Boolean success) {
                if (success) {
                    Utils.showSuccessToast(MerchantProfileActivity.this,
                            MerchantProfileActivity.this.getResources().getString(R.string.route_added_success_message),
                            Toast.LENGTH_LONG);
    ...
    private void setupViewFragment() {
        MerchantProfileFragment MerchantProfileFragment = (com.zopnote.android.merchant.merchantsetup.MerchantProfileFragment) getSupportFragmentManager().findFragmentById(R.id.contentView);

        if(MerchantProfileFragment == null){
            MerchantProfileFragment = MerchantProfileFragment.newInstance();
            ActivityUtils.replaceFragmentInActivity(
                    getSupportFragmentManager(), MerchantProfileFragment, R.id.contentView);
        }
    }

    public static MerchantProfileViewModel obtainViewModel(FragmentActivity activity) {
        // Use a Factory to inject dependencies into the ViewModel
        ViewModelFactory factory = ViewModelFactory.getInstance(activity.getApplication());

        //Add AddRouteViewModel in ViewModelFactory
        MerchantProfileViewModel viewModel =
                ViewModelProviders.of(activity, factory).get(MerchantProfileViewModel.class);
