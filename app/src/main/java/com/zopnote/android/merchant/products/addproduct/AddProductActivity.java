...
import com.zopnote.android.merchant.databinding.AddProductActBinding;

import java.util.ArrayList;
import java.util.List;

public class AddProductActivity extends AppCompatActivity {
    private AddProductActBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.add_product_act);
    ...
    private void setupTabs() {
       ...
       // tabs.add(new Tab(getResources().getString(R.string.magazines_label), "magazines"));
        ...
        final AddProductPagerAdapter productsPagerAdapter = new AddProductPagerAdapter(getSupportFragmentManager(), tabs);
    ...
    private void setScreenName() {
        ...
        String screenName = String.format("AddProduct - %s", currentTab);

        FirebaseAnalytics.getInstance(this)
                .setCurrentScreen(this, screenName, "AddProductActivity");
    }

    public static AddProductViewModel obtainViewModel(FragmentActivity activity) {
        // Use a Factory to inject dependencies into the ViewModel
        ViewModelFactory factory = ViewModelFactory.getInstance(activity.getApplication());

        AddProductViewModel viewModel =
                ViewModelProviders.of(activity, factory).get(AddProductViewModel.class);
    ...
    protected void onResume() {
        ...
        FirebaseAnalytics.getInstance(this)
                .setCurrentScreen(this, ScreenName.ADD_PRODUCT, "AddProductActivity");
