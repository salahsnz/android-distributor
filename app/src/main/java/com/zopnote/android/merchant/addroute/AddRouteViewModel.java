...
import static com.zopnote.android.merchant.AppConstants.ENDPOINT_ADD_ROUTE;
...
public class AddRouteViewModel extends AndroidViewModel {
    ...
    private String LOG_TAG = AddRouteViewModel.class.getSimpleName();
    ...
    public AddRouteViewModel(Application context, Repository repository) {
        super(context);
        Log.d("CSD","ADD ROUTE VIEW MODEL");
    ...
    public void addRouteInfo() {
        ...
        Log.d("CSD","inside Route Info");
        JSONObject jsonObject = getRouteJsonRequest();
        if (true) Log.d("CSD", "request: " + jsonObject.toString());

        final Authenticator authenticator = new Authenticator(ENDPOINT_ADD_ROUTE);
