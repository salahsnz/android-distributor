...
public class AddPauseDatePickerFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        if (flag == FLAG_START_DATE) {
            if(viewmodel.pauseStartDateCalender == null){
                viewmodel.pauseStartDateCalender = FormatUtil.getLocalCalenderNoTime();
            }
